...
<div class="row">
 <div class="form-group col-lg-12">
        <ul class="list-inline pull-right">
            <li><button type="submit" class="btn btn-primary" id="catSave"><i class="icon-globe"></i> <?php echo Flux::Message('Save') ?></button></li>
...
<div class="col-lg-12">
    ...
    <div class="col-lg-9 col-xs-9">
        <input type="text" name="catName"  id="catName" class="form-control" autocomplete="off">
    </div>
    </div>
    ...
    <div class="col-lg-9 col-xs-9">
        <textarea name="catDescription"  id="catDescription" style="height: 100px;" class="form-control"></textarea>
