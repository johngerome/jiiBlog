...
<script type="text/javascript">
     $(document).ready(function() {
        ...
        $( '#tagSave' ).click( function() {
            ...
            $.ajax({
                url: '<?php echo $this->url('ajax', 'tag_create') ?>',
                type: 'POST',
                dataType: 'json',
                async: true,
                data: {
                ...
                { 
                    ...
                    {
                        $('#tag-info').show().html(response['infoMessage']);
                        $('#tagName').val('');
                    }    
                },
...
<h2><i class="icon-tag"></i>&nbsp;<?php echo htmlspecialchars(Flux::message('AddNewTag')) ?></h2>

<div class="form-horizontal">
<div class="row">
<div class="form-group col-lg-12">
    <ul class="list-inline pull-right">
        <li><button type="submit" class="btn btn-primary" id="tagSave"><i class="icon-globe"></i> <?php echo Flux::Message('Save') ?></button></li>
...
<div class="col-lg-12">
    ...
    <div class="col-lg-9 col-xs-9">
        <input type="text" name="tagName"  id="tagName" class="form-control"  autocomplete="off">
    </div>
    </div>
    ...
    <div class="col-lg-9 col-xs-9">
        <textarea name="tagDescription"  id="tagDescription" style="height: 100px;" class="form-control"></textarea>
