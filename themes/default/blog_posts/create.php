...
<script type="text/javascript">
    ...
    {
        $( '#LoadCategories' ).load( '<?php echo $this->url('ajax', 'category_view') ?>' );
    };
    ...
    function allow_comment()
    {
     ...
     $(document).ready(function() {
        ...
        $( '.toggle-div' ).click( function() {
            ...
            fnToogleDoviv ( idTo_Show,  toogleSpeed );
        });
...
<h2><i class="icon-file"></i>&nbsp;<?php echo htmlspecialchars(Flux::message('AddNewPost')) ?></h2>

<form action="<?php echo $this->url('blog_posts', 'create') ?>" method="post" class="form-horizontal" autocomplete="off">
<div class="row">
 <div class="form-group col-lg-12">
        <ul class="list-inline pull-right">
            <li><button type="submit" name="postPublish" value="1" class="btn btn-primary" id="post-published"><i class="icon-globe"></i> <?php echo Flux::Message('Publish') ?></button></li>
...
<div class="col-lg-12">
    ...
    <div class="col-lg-12">
        <input type="text" name="postTitle"  id="postTitle" class="form-control" placeholder="<?php echo Flux::Message('PostTitle') ?>" value="<?php echo (isset($postTitle)) ? $postTitle:'' ?>">
    </div>
    </div>
</div>
</div>
...
<div class="col-lg-12">
    <div class="form-group">
    <div class="col-lg-12">
        <textarea name="postContent"  id="postContent" style="height: 500px;" class="form-control jiiEditor"><?php echo (isset($content )) ? $content:'' ?></textarea>
    </div> 
    </div>
</div>
</div>
...
<div class="col-md-6">
    ...
    <div class="panel-body" id="toggle-category-container">
        <div class="form-group">
            <label for="Category" class="col-lg-2 control-label"><?php echo Flux::Message('Category'); ?></label>
            <div class="col-lg-10">
    ...
    <div class="panel-body" id="show-author-container">
        <div class="form-group">
            ...
            <div class="col-lg-9 col-xs-6">
                <input type="checkbox" name="authorAlias" id="authorAlias"  value="1"> Yes
            </div>
        </div>
        <div class="form-group" id="authorAliasNameCon">
            ...
            <div class="col-lg-9 col-xs-8">
              <input type="text" name="authorAliasName" class="form-control col-xs-12 disabled" id="authorAliasName" value="<?php echo $session->account->userid ?>">
            </div>
        </div>
